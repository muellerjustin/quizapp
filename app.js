...
const fragen = [
    ...
    {
        question: 'Berechne: 5 + 4 * 8^2?',
        answers: [
            { text: "261", correct: true},
    ...
    //     answers: [
    //         { text: "der Fliegenpilz", correct: false},
    //         { text: "der Satanröhrling", correct: false},
    //         { text: "der Grüne Knollenblätterpilz", correct: true},
    //         { text: "der Gemeine Kartoffelbovist", correct: false},
    ...
    // {
    //     question: "Welcher Schwimmstil existiert beim olympischen Lagenschwimmen nicht?",
    //     answers: [
    //         { text: "Schmetterling", correct: false},
    //         { text: "Bauch", correct: true},
    //         { text: "Brust", correct: false},
    //         { text: "Rücken", correct: false},
    ...
    //     answers: [
    //         { text: "Arbeit / Zeit", correct: true},
    //         { text: "Wiederstand * Stromstärke", correct: false},
    //         { text: "Spannung / Stromstärke", correct: false},
    //         { text: "Kraft * Weg", correct: false},
    //     ]
    // },
